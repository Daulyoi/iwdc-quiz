...
export default function Home() {
  ...
  return (
      <div className="w-full h-full min-h-screen lg:grid lg:grid-cols-6 flex flex-col gap-10 lg:pl-32 p-12 lg:items-start items-center bg-[var(--color-iwdc-purple)]">
        <QuizStartForm
          name={name}
